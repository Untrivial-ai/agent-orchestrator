...
func (c *SessionsController) Register(r chi.Router) {
	...
	r.Post("/sessions/{sessionId}/research", c.startResearch)
	r.Get("/sessions/{sessionId}/research", c.listResearch)
	r.Get("/sessions/{sessionId}/research/{researchId}", c.getResearch)
	r.Delete("/sessions/{sessionId}/research/{researchId}", c.cancelResearch)
	r.Post("/sessions/{sessionId}/research/{researchId}/approval", c.resolveResearchApproval)
