...
var schemaNames = map[string]string{
	...
	"ControllersQuotaCapabilitiesResponse":                "QuotaCapabilitiesResponse",
	"ControllersQuotaLimitResponse":                       "QuotaLimitResponse",
	"ControllersQuotaBalanceResponse":                     "QuotaBalanceResponse",
	"ControllersProviderQuotaResponse":                    "ProviderQuotaResponse",
	"ControllersListProviderQuotaResponse":                "ListProviderQuotaResponse",
	"ControllersQuotaAlertsQuery":                         "QuotaAlertsQuery",
	"ControllersQuotaAlertResponse":                       "QuotaAlertResponse",
	"ControllersListQuotaAlertsResponse":                  "ListQuotaAlertsResponse",
	"ControllersQuotaProviderAccountParams":               "QuotaProviderAccountParams",
	"ControllersQuotaHistoryQuery":                        "QuotaHistoryQuery",
	"ControllersQuotaHistoryPointResponse":                "QuotaHistoryPointResponse",
	"ControllersListQuotaHistoryResponse":                 "ListQuotaHistoryResponse",
...
func usageOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/usage/plans", id: "listProviderQuota", tag: "usage",
			summary: "List account-level subscription quota for every observed provider",
			resps: []respUnit{
		...
		},
		{
			...
			resps: []respUnit{
				{http.StatusOK, controllers.ListQuotaAlertsResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
		...
		{
			method: http.MethodGet, path: "/api/v1/usage/plans/{provider}/accounts/{accountId}", id: "getProviderQuota", tag: "usage",
			summary:    "Get one provider account's current subscription quota",
			pathParams: []any{controllers.QuotaProviderAccountParams{}},
			resps: []respUnit{
				{http.StatusOK, controllers.ProviderQuotaResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
		...
		{
			method: http.MethodGet, path: "/api/v1/usage/plans/{provider}/accounts/{accountId}/history", id: "getProviderQuotaHistory", tag: "usage",
			summary:    "Get bounded quota-position history for one provider account",
			pathParams: []any{controllers.QuotaProviderAccountParams{}, controllers.QuotaHistoryQuery{}},
			resps: []respUnit{
				{http.StatusOK, controllers.ListQuotaHistoryResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
		...
		{
			method: http.MethodPost, path: "/api/v1/usage/plans/{provider}/accounts/{accountId}/refresh", id: "refreshProviderQuota", tag: "usage",
			summary:    "Refresh quota through a provider that supports an on-demand read",
			pathParams: []any{controllers.QuotaProviderAccountParams{}},
			resps: []respUnit{
				{http.StatusOK, controllers.ProviderQuotaResponse{}},
				{http.StatusConflict, envelope.APIError{}},
