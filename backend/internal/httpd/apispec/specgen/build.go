...
func sessionOperations() []operation {
	return []operation{
		...
		{method: http.MethodGet, path: "/api/v1/session-import/search/{resultId}/destination", id: "getSessionImportDestination", tag: "sessions", summary: "getSessionImportDestination", pathParams: []any{controllers.SessionSearchResultParam{}}, resps: []respUnit{{http.StatusOK, sessionimportsvc.Destination{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusUnprocessableEntity, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}}},
