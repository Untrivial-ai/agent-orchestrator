...
func TestPlansMatchAuthenticationMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{"kimi", "Log in to Kimi", "kimi", "Kimi opens its login picker after it finishes starting; type /login if it does not", "https://moonshotai.github.io/kimi-code/en/", "", ActionLogin, []string{"kimi"}},
