...
func TestPlansMatchAuthenticationMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{"junie", "Set up Junie", "junie", "Choose JetBrains account, Junie API key, or BYOK in the welcome screen", "https://junie.jetbrains.com/docs/junie-cli.html", "", ActionSetup, []string{"junie"}},
	}
