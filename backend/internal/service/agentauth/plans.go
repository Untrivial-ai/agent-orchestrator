...
var plans = []Plan{
	...
	documentationPlan("fx", ActionInstructions, "Set up fx", "Configure an fx provider using its official setup documentation; local configuration does not verify provider authorization", "https://fx.sh/docs"),
}
