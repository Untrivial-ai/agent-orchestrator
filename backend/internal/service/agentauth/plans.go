...
var plans = []Plan{
	...
	plan("junie", ActionSetup, "Set up Junie", []string{"junie"}, "Choose JetBrains account, Junie API key, or BYOK in the welcome screen", "https://junie.jetbrains.com/docs/junie-cli.html"),
}
