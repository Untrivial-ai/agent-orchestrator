...
UPDATE sessions SET
    ...
    launch_readiness_state = sqlc.arg(launch_readiness_state),
    launch_readiness_launch_id = sqlc.arg(launch_readiness_launch_id),
    launch_readiness_conversation_id = sqlc.arg(launch_readiness_conversation_id),
    launch_readiness_cause = sqlc.arg(launch_readiness_cause),
    launch_readiness_resume = sqlc.arg(launch_readiness_resume),
    launch_readiness_updated_at = sqlc.arg(launch_readiness_updated_at),
    updated_at = sqlc.arg(updated_at)
...
UPDATE sessions SET
    ...
    launch_readiness_updated_at = CASE WHEN launch_readiness_state IN ('launching', 'needs_input') THEN sqlc.arg(stopped_at) ELSE launch_readiness_updated_at END,
...
UPDATE sessions SET
    ...
    launch_readiness_launch_id = sqlc.arg(target_generation_id),
    launch_readiness_conversation_id = sqlc.arg(target_native_session_id),
    launch_readiness_cause = '',
    launch_readiness_resume = sqlc.arg(target_native_session_id) <> '',
    launch_readiness_updated_at = sqlc.arg(activated_at),
...
UPDATE sessions SET
    ...
    launch_readiness_state = 'launching',
    launch_readiness_launch_id = sqlc.arg(target_controller_generation),
    launch_readiness_conversation_id = sqlc.arg(provider_conversation_id),
    launch_readiness_cause = '',
    launch_readiness_resume = sqlc.arg(provider_conversation_id) <> '',
    launch_readiness_updated_at = sqlc.arg(activated_at),
    updated_at = sqlc.arg(activated_at)
WHERE id = sqlc.arg(session_id)
  AND is_terminated = 0
