-- Summary: retain unfinished session startup ownership for restart recovery.
-- +goose Up
ALTER TABLE sessions ADD COLUMN startup_operation TEXT NOT NULL DEFAULT '';
...
WHEN OLD.activity_state <> NEW.activity_state
    ...
    OR OLD.startup_operation <> NEW.startup_operation
BEGIN
...
-- +goose Down
DROP TRIGGER IF EXISTS sessions_cdc_update;
ALTER TABLE sessions DROP COLUMN startup_operation;
