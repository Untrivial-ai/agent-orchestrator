...
//
// Source: codex-cli 0.153.4 app-server generate-json-schema
// Method surface: 821a34c2aebae893
//
// Regenerate with:
//
...
const ProviderVersion = "codex-cli 0.153.4"

// ProtocolDigest fingerprints the generated method surface.
const ProtocolDigest = "821a34c2aebae893"
...
const (
	...
	MethodAutoApprovalReviewStrictReviewRequired = "autoApprovalReview/strictReviewRequired"
	...
	MethodProjectChanged             = "project/changed"
	...
	MethodThreadProjectUpdated              = "thread/project/updated"
...
var Methods = []MethodInfo{
	...
	{Name: "account/usage/read", Direction: "ClientRequest", Params: "GetAccountTokenUsageParams", Result: "GetAccountTokenUsageResponse"},
	...
	{Name: "plugin/reconcile", Direction: "ClientRequest", Params: "PluginReconcileParams", Result: "PluginReconcileResponse"},
	...
	{Name: "thread/items/list", Direction: "ClientRequest", Params: "ThreadItemsListParams", Result: "ThreadItemsListResponse"},
	...
	{Name: "thread/revert", Direction: "ClientRequest", Params: "ThreadRevertParams", Result: "ThreadRevertResponse"},
	{Name: "thread/rollback", Direction: "ClientRequest", Params: "ThreadRollbackParams", Result: "ThreadRollbackResponse"},
	{Name: "thread/section/move", Direction: "ClientRequest", Params: "ThreadSectionMoveParams", Result: "ThreadSectionMoveResponse"},
	...
	{Name: "thread/turns/list", Direction: "ClientRequest", Params: "ThreadTurnsListParams", Result: "ThreadTurnsListResponse"},
	...
	{Name: "threadSection/create", Direction: "ClientRequest", Params: "ThreadSectionCreateParams", Result: "ThreadSectionCreateResponse"},
	{Name: "threadSection/delete", Direction: "ClientRequest", Params: "ThreadSectionDeleteParams", Result: "ThreadSectionDeleteResponse"},
	{Name: "threadSection/list", Direction: "ClientRequest", Params: "ThreadSectionListParams", Result: "ThreadSectionListResponse"},
	{Name: "threadSection/update", Direction: "ClientRequest", Params: "ThreadSectionUpdateParams", Result: "ThreadSectionUpdateResponse"},
	...
	{Name: "autoApprovalReview/strictReviewRequired", Direction: "ServerNotification", Params: "StrictReviewRequiredNotification", Result: ""},
	...
	{Name: "mcpServer/event/stream/notification", Direction: "ServerNotification", Params: "McpServerEventStreamNotification", Result: ""},
	...
	{Name: "modelProvider/authRecoveryCompleted", Direction: "ServerNotification", Params: "AuthRecoveryNotification", Result: ""},
	{Name: "modelProvider/authRecoveryStarted", Direction: "ServerNotification", Params: "AuthRecoveryNotification", Result: ""},
	...
	{Name: "project/changed", Direction: "ServerNotification", Params: "ProjectChangedNotification", Result: ""},
	...
	{Name: "thread/project/updated", Direction: "ServerNotification", Params: "ThreadProjectUpdatedNotification", Result: ""},
	{Name: "thread/queue/changed", Direction: "ServerNotification", Params: "ThreadQueueChangedNotification", Result: ""},
	...
	{Name: "thread/realtime/item/completed", Direction: "ServerNotification", Params: "ThreadRealtimeItemCompletedNotification", Result: ""},
	{Name: "thread/realtime/item/started", Direction: "ServerNotification", Params: "ThreadRealtimeItemStartedNotification", Result: ""},
	{Name: "thread/realtime/item/transcript/delta", Direction: "ServerNotification", Params: "ThreadRealtimeItemTranscriptDeltaNotification", Result: ""},
	...
	{Name: "thread/reverted", Direction: "ServerNotification", Params: "ThreadRevertedNotification", Result: ""},
...
// AppLinkConfig: Approval settings for a connected account within an app.
type AppLinkConfig struct {
	ApprovalsReviewer        *ApprovalsReviewer `json:"approvals_reviewer,omitempty"`
	DefaultToolsApprovalMode *AppToolApproval   `json:"default_tools_approval_mode,omitempty"`
}

// AppLinksConfig: Account settings for a single app.
type AppLinksConfig = json.RawMessage
...
const (
	...
	ClientRequestTypePluginReconcile                        ClientRequestType = "plugin/reconcile"
	...
	ClientRequestTypeThreadItemsList                        ClientRequestType = "thread/items/list"
	...
	ClientRequestTypeThreadRevert                           ClientRequestType = "thread/revert"
	ClientRequestTypeThreadRollback                         ClientRequestType = "thread/rollback"
	ClientRequestTypeThreadSectionMove                      ClientRequestType = "thread/section/move"
	...
	ClientRequestTypeThreadTurnsList                        ClientRequestType = "thread/turns/list"
	...
	ClientRequestTypeThreadSectionCreate                    ClientRequestType = "threadSection/create"
	ClientRequestTypeThreadSectionDelete                    ClientRequestType = "threadSection/delete"
	ClientRequestTypeThreadSectionList                      ClientRequestType = "threadSection/list"
	ClientRequestTypeThreadSectionUpdate                    ClientRequestType = "threadSection/update"
...
// CommandExecutionApprovalKind: Distinguishes a command approval from input sent to an existing terminal.
...
const (
	...
	ConfigLayerSourceTypePackagedDefaults                ConfigLayerSourceType = "packagedDefaults"
...
const (
	...
	ConfiguredHookHandlerTypeMcpTool ConfiguredHookHandlerType = "mcp_tool"
...
// CyberAccessProgram: Requested cyber treatment for a ChatGPT-authenticated Codex turn. Authorization and model-tier restrictions re…
...
type GetAccountRateLimitsResponse struct {
	...
	// Optional backend-owned banner from the same usage read. Its nested keys retain the backend's snake_case contra…
...
const (
	...
	GuardianApprovalReviewActionTypeWriteStdin         GuardianApprovalReviewActionType = "writeStdin"
)
...
// A tagged union: HandlerType selects which fields carry values.
type HookMetadata struct {
	HandlerType HookMetadataType `json:"handlerType"`
	Async       *bool            `json:"async,omitempty"`
	Command     *string          `json:"command,omitempty"`
	Server      *string          `json:"server,omitempty"`
	Tool        *string          `json:"tool,omitempty"`
...
// HookMetadataType is the discriminator of HookMetadata.
type HookMetadataType string

const (
	HookMetadataTypeAgent   HookMetadataType = "agent"
	HookMetadataTypeCommand HookMetadataType = "command"
	HookMetadataTypeMcpTool HookMetadataType = "mcpTool"
	HookMetadataTypePrompt  HookMetadataType = "prompt"
)
...
type InitializeCapabilities struct {
	...
	// Legacy opt-in for the `openai/form` MCP extension. New clients should declare `openai/form` in [`Self::extensi…
...
const (
	...
	LoginAccountParamsTypeAmazonBedrockAccessKeys LoginAccountParamsType = "amazonBedrockAccessKeys"
...
type ManagedHooksRequirements struct {
	Interrupt         []ConfiguredHookMatcherGroup `json:"Interrupt,omitempty"`
...
const (
	...
	McpServerElicitationRequestParamsTypeOpenaiForm McpServerElicitationRequestParamsType = "openaiForm"
...
// MultiAgentVersion: Multi-agent runtime supported by a model.
...
// PluginReconcileChangedPlugin: Runtime categories affected by this change, not just capabilities currently present. Flags describe declaratio…
...
// PluginReconcileResponse: Bundle and installed-state changes observed by this pass, not a runtime-readiness acknowledgement or a cumulat…
type PluginReconcileResponse struct {
	// Plugins affected by bundle changes, enablement changes, or removals. Installed-state changes compare against t…
	ChangedPlugins []PluginReconcileChangedPlugin `json:"changedPlugins"`
	// Subset of failures for which the requested bundle could not be materialized. A previously cached version may s…
...
// ResponseUsageMetadata: Usage metadata reported for one upstream response.
...
const (
	...
	ServerNotificationTypeAutoApprovalReviewStrictReviewRequired  ServerNotificationType = "autoApprovalReview/strictReviewRequired"
	...
	ServerNotificationTypeMcpServerEventStreamNotification        ServerNotificationType = "mcpServer/event/stream/notification"
	...
	ServerNotificationTypeModelProviderAuthRecoveryCompleted      ServerNotificationType = "modelProvider/authRecoveryCompleted"
	ServerNotificationTypeModelProviderAuthRecoveryStarted        ServerNotificationType = "modelProvider/authRecoveryStarted"
	...
	ServerNotificationTypeProjectChanged                          ServerNotificationType = "project/changed"
	...
	ServerNotificationTypeThreadProjectUpdated                    ServerNotificationType = "thread/project/updated"
	ServerNotificationTypeThreadQueueChanged                      ServerNotificationType = "thread/queue/changed"
	...
	ServerNotificationTypeThreadRealtimeItemCompleted             ServerNotificationType = "thread/realtime/item/completed"
	ServerNotificationTypeThreadRealtimeItemStarted               ServerNotificationType = "thread/realtime/item/started"
	ServerNotificationTypeThreadRealtimeItemTranscriptDelta       ServerNotificationType = "thread/realtime/item/transcript/delta"
	...
	ServerNotificationTypeThreadReverted                          ServerNotificationType = "thread/reverted"
...
type Thread struct {
	...
	ID string `json:"id"`
	// Current configured model when loaded, otherwise the latest persisted model. Null when unavailable. This is not…
	Model *string `json:"model,omitempty"`
	...
	// Current configured reasoning effort when loaded, otherwise the latest persisted effort. Null when unset or una…
...
type ThreadForkParams struct {
	...
	Ephemeral             *bool                      `json:"ephemeral,omitempty"`
	// When true, return only thread metadata and live fork state without populating `thread.turns`. This is useful w…
...
const (
	...
	ThreadItemTypeFunctionCallOutput  ThreadItemType = "functionCallOutput"
...
type ThreadListParams struct {
	...
	// Omit to include every section, set to `null` for unsectioned threads, or provide a section ID to return only t…
...
type ThreadReadParams struct {
	// When true, include turns and their items from rollout history. Full-history hydration is deprecated for pagina…
...
// ThreadRealtimeBemItemPresentation: EXPERIMENTAL - how an existing agent item appears in a realtime conversation.
//
// A tagged union: Type selects which fields carry values.
type ThreadRealtimeBemItemPresentation struct {
	Type  ThreadRealtimeBemItemPresentationType `json:"type"`
	Index *uint64                               `json:"index,omitempty"`
}

// ThreadRealtimeBemItemPresentationType is the discriminator of ThreadRealtimeBemItemPresentation.
type ThreadRealtimeBemItemPresentationType string

const (
	ThreadRealtimeBemItemPresentationTypeInlineMarkdown      ThreadRealtimeBemItemPresentationType = "inlineMarkdown"
	ThreadRealtimeBemItemPresentationTypeInlineVisualization ThreadRealtimeBemItemPresentationType = "inlineVisualization"
	ThreadRealtimeBemItemPresentationTypeWholeItem           ThreadRealtimeBemItemPresentationType = "wholeItem"
)
...
// ThreadRealtimeItem: EXPERIMENTAL - a thread-scoped realtime item in the canonical timeline.
//
// A tagged union: Type selects which fields carry values.
type ThreadRealtimeItem struct {
	Type         ThreadRealtimeItemType             `json:"type"`
	Role         *ThreadRealtimeTranscriptRole      `json:"role,omitempty"`
	Text         *string                            `json:"text,omitempty"`
	ItemID       *string                            `json:"item_id,omitempty"`
	Presentation *ThreadRealtimeBemItemPresentation `json:"presentation,omitempty"`
	TurnID       *string                            `json:"turn_id,omitempty"`
	Outcome      *ThreadRealtimeSessionOutcome      `json:"outcome,omitempty"`
}

// ThreadRealtimeItemType is the discriminator of ThreadRealtimeItem.
type ThreadRealtimeItemType string

const (
	ThreadRealtimeItemTypeBemItemPromoted        ThreadRealtimeItemType = "bemItemPromoted"
	ThreadRealtimeItemTypeRealtimeSessionClosed  ThreadRealtimeItemType = "realtimeSessionClosed"
	ThreadRealtimeItemTypeRealtimeSessionStarted ThreadRealtimeItemType = "realtimeSessionStarted"
	ThreadRealtimeItemTypeTranscriptSegment      ThreadRealtimeItemType = "transcriptSegment"
)
...
// ThreadRealtimeItemCompletedNotification: EXPERIMENTAL - a realtime timeline item published after canonical commit.
type ThreadRealtimeItemCompletedNotification struct {
	Item     ThreadRealtimeItem `json:"item"`
	ThreadID string             `json:"threadId"`
}

// ThreadRealtimeItemStartedNotification: EXPERIMENTAL - a realtime timeline item started before its content streams.
type ThreadRealtimeItemStartedNotification struct {
	Item     ThreadRealtimeItem `json:"item"`
	ThreadID string             `json:"threadId"`
}

// ThreadRealtimeItemTranscriptDeltaNotification: EXPERIMENTAL - text appended to an active realtime transcript item.
...
const (
	ThreadRealtimeStartTransportTypeExistingCall ThreadRealtimeStartTransportType = "existingCall"
...
type ThreadResumeParams struct {
	...
	Cwd                   *string                    `json:"cwd,omitempty"`
	DeveloperInstructions *string                    `json:"developerInstructions,omitempty"`
	// When true, return only thread metadata and live-resume state without populating `thread.turns`. This is useful…
	ExcludeTurns *bool `json:"excludeTurns,omitempty"`
...
type ThreadResumeResponse struct {
	...
	// Environment-native paths to instruction source files currently loaded for this thread.
	InstructionSources []LegacyAppPathString `json:"instructionSources,omitempty"`
	// Opaque cursor for hydrating paginated items backwards. Pass this as `cursor` to `thread/items/list` with `sort…
	...
	ServiceTier *string       `json:"serviceTier,omitempty"`
	Thread      Thread        `json:"thread"`
	// Opaque cursor for hydrating paginated turns backwards. Pass this as `cursor` to `thread/turns/list` with `sort…
	TurnsBackwardsCursor *string `json:"turnsBackwardsCursor,omitempty"`
}

// ThreadRevertParams: Replace a paginated thread's durable history with the prefix before one turn. This only changes persisted conv…
...
// ThreadSection: An independently persisted, user-visible thread section.
...
// ThreadSectionAppearance: Extensible visual presentation for a custom thread section.
type ThreadSectionAppearance struct {
	Color *string `json:"color,omitempty"`
	Icon  *string `json:"icon,omitempty"`
}

// ThreadSectionCreateParams: Parameters for creating an independently persisted thread section.
...
// ThreadSectionCreateResponse: The independently persisted section created by the server.
type ThreadSectionCreateResponse struct {
	Section ThreadSection `json:"section"`
}

// ThreadSectionDeleteParams: Parameters for deleting an independently persisted thread section.
type ThreadSectionDeleteParams struct {
	// The stable, server-generated identity of the section to delete.
	SectionID string `json:"sectionId"`
}

// ThreadSectionDeleteResponse: Successful deletion does not return additional section data.
type ThreadSectionDeleteResponse = json.RawMessage

// ThreadSectionListParams: Parameters for listing independently persisted thread sections.
...
// ThreadSectionListResponse: One page of independently persisted thread sections.
...
// ThreadSectionMoveParams: Parameters for moving a thread within a server-owned section ordering.
...
type ThreadSectionMoveResponse = json.RawMessage

// ThreadSectionUpdateParams: Parameters for updating an independently persisted thread section.
...
// ThreadSectionUpdateResponse: The independently persisted section after its name is updated.
...
type ThreadShellCommandParams struct {
	...
	Command  string `json:"command"`
	ThreadID string `json:"threadId"`
	// Maximum execution time in milliseconds. Defaults to one hour when omitted or null. Must be non-negative; zero …
	TimeoutMs *int64 `json:"timeoutMs,omitempty"`
}
...
// ThreadTimelineEntry: EXPERIMENTAL - one item or turn boundary in canonical rollout order.
//
// A tagged union: Type selects which fields carry values.
type ThreadTimelineEntry struct {
	Type        ThreadTimelineEntryType `json:"type"`
	Item        json.RawMessage         `json:"item,omitempty"`
	Position    *uint64                 `json:"position,omitempty"`
	TurnID      *string                 `json:"turnId,omitempty"`
	StartedAt   *int64                  `json:"started_at,omitempty"`
	TurnID_     *string                 `json:"turn_id,omitempty"`
...
// ThreadTimelineEntryType is the discriminator of ThreadTimelineEntry.
type ThreadTimelineEntryType string

const (
	ThreadTimelineEntryTypeItem          ThreadTimelineEntryType = "item"
	ThreadTimelineEntryTypeRealtime      ThreadTimelineEntryType = "realtime"
	ThreadTimelineEntryTypeTurnCompleted ThreadTimelineEntryType = "turnCompleted"
	ThreadTimelineEntryTypeTurnStarted   ThreadTimelineEntryType = "turnStarted"
)
...
type ThreadTurnsListResponse struct {
	...
	BackwardsCursor *string `json:"backwardsCursor,omitempty"`
	Data            []Turn  `json:"data"`
	// Opaque cursor to pass to the next call to continue after the last turn. if None, there are no more turns to re…
	NextCursor *string `json:"nextCursor,omitempty"`
}
...
type TurnStartParams struct {
	...
	ServiceTier *string `json:"serviceTier,omitempty"`
	// Override the service tier only when this request starts a new turn. Use "default" for standard speed. Omitted …
	...
	// Optional source classification for the caller that starts this turn. Ignored when this request steers an alrea…
