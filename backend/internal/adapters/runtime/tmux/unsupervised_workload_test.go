...
func TestUnsupervisedWorkloadLaunchShapes(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "unproven login shell", panes: "100 0", processes: "100 1 -bash\n", alive: true},
		...
		{name: "extra dead panes", panes: "100 1\n200 1", wantErr: true},
		{name: "unproven bare shell", panes: "100 0", processes: "100 1 /bin/sh\n", alive: true},
