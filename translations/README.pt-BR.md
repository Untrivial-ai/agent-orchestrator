...
[**Baixar o AO**](#instalação) &nbsp;&bull;&nbsp; [Documentação](https://orchestrator.inc/docs) &nbsp;&bull;&nbsp; [Versões](https://github.com/Untrivial-ai/agent-orchestrator/releases) &nbsp;&bull;&nbsp; [Como contribuir](../CONTRIBUTING.md) &nbsp;&bull;&nbsp; [Discord](https://discord.com/invite/UZv7JjxbwG)
...
**opencode** em um único fluxo supervisionado.
...
Abra o Agent Orchestrator e indique o repositório que você deseja que o AO gerencie. O aplicativo desktop executa o daemon para você, portanto não é necessário usar a CLI. Consulte o [guia de instalação](https://orchestrator.inc/docs/installation) para configurar as CLIs dos agentes e resolver problemas.
...
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| [Documentação do produto](https://orchestrator.inc/docs)                   | Instalação, configuração de agentes e uso cotidiano do produto.                                      |
