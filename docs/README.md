...
| [performance/desktop/README.md](performance/desktop/README.md) | Desktop cold start, multi-session memory, and terminal input→echo benchmarks (reproducible script + machine notes). |
