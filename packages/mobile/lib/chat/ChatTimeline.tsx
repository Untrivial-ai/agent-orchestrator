...
function ChangedFiles({ turn }: { turn: ConversationTurn }) {
	...
	return <View style={styles.planCard}>
		<Pressable style={styles.planHeader} onPress={() => { haptics.tap(); setOpen((value) => !value); }}>
			...
			<Text style={{ color: t.green, fontSize: type.caption2.fontSize }}>+{files.reduce((sum, file) => sum + file.additions, 0)}</Text>
			<Text style={{ color: t.red, fontSize: type.caption2.fontSize }}>−{files.reduce((sum, file) => sum + file.deletions, 0)}</Text>
			<Feather name={open ? "chevron-up" : "chevron-down"} size={12} color={t.textTertiary} />
		</Pressable>
...
const makeStyles = (t: Theme) => StyleSheet.create({
	...
	attachmentRetry: { color: t.accent, fontSize: type.caption2.fontSize, fontWeight: "600" },
	...
	originLabel: { color: t.textTertiary, fontSize: type.caption2.fontSize, fontWeight: "700", textTransform: "uppercase", letterSpacing: 0.7 },
	originText: { color: t.textSecondary, fontSize: type.subheadline.fontSize, lineHeight: type.subheadline.lineHeight },
	originMore: { alignSelf: "flex-start", flexDirection: "row", alignItems: "center", gap: space.xxs, paddingVertical: space.xxs },
	originMoreText: { color: t.accent, fontSize: type.caption2.fontSize, fontWeight: "600" },
	steerBubble: { backgroundColor: t.bgSubtle },
	steerLabel: { color: t.textTertiary, fontSize: type.caption2.fontSize, letterSpacing: 1, fontWeight: "700", marginBottom: space.hair },
	assistantRow: { paddingVertical: space.lg },
	sender: { color: t.textTertiary, fontSize: type.caption2.fontSize, fontWeight: "600", marginBottom: space.xxs },
	...
	jumpText: { color: t.textPrimary, fontSize: type.caption2.fontSize, fontWeight: "700" },
	...
	systemTitle: { color: t.textPrimary, fontSize: type.caption2.fontSize, fontWeight: "600" },
	systemDetail: { color: t.textTertiary, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight, marginTop: space.hair },
	...
	activityProgress: { maxWidth: "28%", color: t.textFaint, fontSize: type.caption2.fontSize },
	activityStopped: { color: t.textFaint, fontSize: type.caption2.fontSize, fontWeight: "600" },
	...
	reviewDecision: { color: t.green, fontSize: type.caption2.fontSize, fontWeight: "700" },
	risk: { color: t.amber, fontSize: type.caption2.fontSize, fontWeight: "700", textTransform: "uppercase" },
	reviewRationale: { color: t.textPrimary, backgroundColor: t.bgColumn, borderRadius: 8, padding: space.sm, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight },
	...
	runText: { flex: 1, color: t.textTertiary, fontSize: type.caption1.fontSize },
	runFailed: { color: t.red, fontSize: type.caption2.fontSize, fontWeight: "600" },
	runStopped: { color: t.textFaint, fontSize: type.caption2.fontSize, fontWeight: "600" },
	...
	subagentLabel: { flex: 1, color: t.textFaint, fontSize: type.caption2.fontSize, letterSpacing: 0.8 },
	detailCopy: { color: t.textSecondary, fontSize: type.footnote.fontSize, lineHeight: type.footnote.lineHeight },
	...
	partial: { color: t.textFaint, fontSize: type.caption2.fontSize },
	...
	turnState: { color: t.textTertiary, fontSize: type.caption1.fontSize, fontWeight: "500" },
	turnError: { color: t.red, fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight, textAlign: "right" },
	...
	rollbackTitle: { color: t.textPrimary, fontWeight: "700", fontSize: type.footnote.fontSize },
	rollbackCopy: { color: t.textSecondary, fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight },
	...
	planTitle: { flex: 1, color: t.textSecondary, fontSize: type.caption1.fontSize, fontWeight: "600" },
	planLive: { color: t.orange, fontSize: type.caption2.fontSize, letterSpacing: 0.7, fontWeight: "700" },
	...
	planStepText: { flex: 1, color: t.textSecondary, fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight },
	planStepState: { color: t.textFaint, fontSize: type.caption2.fontSize, textTransform: "uppercase" },
	...
	fileMark: { width: 13, fontFamily: t.fontMono, fontSize: type.caption2.fontSize, fontWeight: "700" },
	...
	approvalStatusText: { color: t.textPrimary, fontSize: type.footnote.fontSize, fontWeight: "700" },
	...
	approvalResolvedLabel: { color: t.textTertiary, fontSize: type.caption2.fontSize, fontWeight: "600" },
	...
	requestHeading: { flex: 1, color: t.textPrimary, fontSize: type.footnote.fontSize, fontWeight: "700" },
	requestBadge: { borderRadius: 8, paddingHorizontal: space.sm, paddingVertical: space.xxs },
	requestBadgeText: { fontSize: type.caption2.fontSize, fontWeight: "700" },
	requestCopy: { color: t.textSecondary, fontSize: type.footnote.fontSize, lineHeight: type.footnote.lineHeight },
	...
	inputRequestStatusText: { color: t.textTertiary, fontSize: type.caption1.fontSize, fontWeight: "600" },
	...
	actionLabel: { fontSize: type.caption1.fontSize, fontWeight: "700" },
	actionHint: { maxWidth: 180, color: t.textTertiary, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight, marginTop: space.hair },
	form: { gap: space.sm },
	field: { gap: space.xs },
	inputEyebrow: { color: t.textTertiary, fontSize: type.caption2.fontSize, fontWeight: "700", letterSpacing: 0.7, textTransform: "uppercase" },
	inputQuestion: { color: t.textPrimary, fontSize: type.callout.fontSize, lineHeight: type.callout.lineHeight, fontWeight: "500" },
	inputLabel: { color: t.textPrimary, fontSize: type.caption1.fontSize, fontWeight: "600" },
	inputHint: { color: t.textTertiary, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight },
	...
	validation: { color: t.red, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight },
	...
	compactionText: { color: t.textFaint, fontSize: type.caption2.fontSize, letterSpacing: 1 },
	...
	errorTitle: { color: t.red, fontSize: type.caption1.fontSize, fontWeight: "700" },
	errorCopy: { marginTop: space.xxs, color: t.textSecondary, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight },
	...
	emptyTitle: { color: t.textPrimary, fontSize: type.body.fontSize, fontWeight: "700", marginBottom: space.xs },
	emptyCopy: { color: t.textTertiary, fontSize: type.footnote.fontSize, lineHeight: type.footnote.lineHeight, textAlign: "center" },
});
