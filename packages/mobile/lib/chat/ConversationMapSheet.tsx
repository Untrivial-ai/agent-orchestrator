...
const makeStyles = (t: Theme) => StyleSheet.create({
	...
	sectionTitle: { color: t.textTertiary, fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight, fontWeight: "600" },
	...
	spacer: { flex: 1 },
	state: { fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight, fontWeight: "500" },
	title: { color: t.textPrimary, fontSize: type.callout.fontSize, fontWeight: "600", lineHeight: type.callout.lineHeight, letterSpacing: -0.15 },
	detail: { color: t.textTertiary, fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight },
	...
	emptyTitle: { color: t.textPrimary, fontSize: type.callout.fontSize, fontWeight: "700" },
	emptyCopy: { maxWidth: 270, color: t.textTertiary, fontSize: type.footnote.fontSize, lineHeight: type.footnote.lineHeight, textAlign: "center", marginTop: space.xs },
});
