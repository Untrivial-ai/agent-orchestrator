...
const makeStyles = (t: Theme) =>
	StyleSheet.create({
		root: { gap: 10 },
		body: { color: t.textPrimary, fontSize: prose.fontSize, lineHeight: prose.lineHeight },
		heading: { color: t.textPrimary, fontSize: type.title3.fontSize, lineHeight: type.title3.lineHeight, fontWeight: "700", marginTop: space.xs },
		smallHeading: { fontSize: type.callout.fontSize, lineHeight: type.callout.lineHeight },
		...
		marker: { width: 20, color: t.textTertiary, fontSize: type.subheadline.fontSize, lineHeight: prose.lineHeight, textAlign: "right" },
		...
		quoteText: { color: t.textSecondary, fontSize: type.subheadline.fontSize, lineHeight: prose.lineHeight, fontStyle: "italic" },
		...
		codeLanguage: { flex: 1, color: t.textTertiary, fontFamily: t.fontMono, ...microLabel, textTransform: "uppercase" },
		copyButton: { flexDirection: "row", alignItems: "center", gap: space.xxs, paddingVertical: space.xs, paddingLeft: space.md },
		copyLabel: { color: t.textTertiary, fontSize: type.caption2.fontSize, fontWeight: "600" },
		...
		imageCaption: { color: t.textTertiary, fontSize: type.caption2.fontSize, paddingHorizontal: space.sm, paddingVertical: space.xs, borderTopWidth: 1, borderTopColor: t.borderSubtle },
		imageFallback: { color: t.textTertiary, fontSize: type.caption1.fontSize, fontStyle: "italic" },
		...
		tableCell: { minWidth: 110, maxWidth: 260, color: t.textSecondary, fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight, paddingHorizontal: space.sm, paddingVertical: space.xs, borderLeftWidth: StyleSheet.hairlineWidth, borderLeftColor: t.borderSubtle },
