...
const makeStyles = (t: Theme) => StyleSheet.create({
	...
	errorText: { flex: 1, color: t.red, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight },
	...
	rerouteTitle: { color: t.textPrimary, fontSize: type.caption1.fontSize, fontWeight: "700" },
	rerouteCopy: { color: t.textSecondary, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight, marginTop: space.hair },
	section: { gap: space.xs },
	sectionTitle: { flexDirection: "row", alignItems: "center", gap: space.sm },
	sectionLabel: { color: t.textPrimary, fontSize: type.footnote.fontSize, fontWeight: "700" },
	sectionDescription: { color: t.textTertiary, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight },
	...
	empty: { color: t.textTertiary, fontSize: type.caption1.fontSize, lineHeight: type.caption1.lineHeight, textAlign: "center", paddingVertical: space.xxl },
	...
	choiceLabel: { color: t.textPrimary, fontSize: type.footnote.fontSize, fontWeight: "600" },
	choiceHint: { color: t.textTertiary, fontSize: type.caption2.fontSize, lineHeight: type.caption2.lineHeight, marginTop: space.hair },
