...
export const QUIET_ACTION_PILL =
	"inline-flex h-7 items-center gap-1.5 rounded-full border border-border-strong bg-background/20 px-2.5 text-md-sm text-foreground/90 transition-colors hover:bg-interactive-hover focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-ring/40 disabled:pointer-events-none disabled:opacity-50";
...
const ACCENT_LABEL =
	"inline-flex items-center gap-1.5 px-2.5 text-md-sm transition-colors hover:bg-logo-accent-bright focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-50";
