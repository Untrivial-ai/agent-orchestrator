...
// GitHub mark: the octocat silhouette, drawn as a filled monochrome path so it
// inherits color and size from its slot. lucide no longer ships brand marks, and
// the colour version carries a background chip that would not theme.
