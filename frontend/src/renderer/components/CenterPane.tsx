...
function SessionPaneTab({
	...
	return (
		<button
			...
			className={cn(
				"group relative inline-flex min-w-shell-tab-min shrink-0 self-stretch cursor-pointer items-center gap-1.5 truncate text-control leading-none transition-colors focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-accent/50",
				connected
					? "w-shell-tab-connected border-x border-transparent px-2 text-left font-normal"
					: "max-w-shell-tab-max border-r border-border bg-surface px-3 font-medium text-foreground",
				connected
					? isActive
