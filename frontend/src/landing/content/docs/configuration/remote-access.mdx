...
The same listener is what another desktop connects to as a remote host. See [Remote sessions](/docs/configuration/remote-sessions) for that flow and for the trust boundary it assumes.
