---
title: Changelog
description: Where to find weekly product updates and AO desktop/mobile release notes.
---

AO publishes a **weekly changelog** on the marketing site at
[orchestrator.inc/changelog](https://orchestrator.inc/changelog): Features,
Improvements, and Fixes with PR links, contributor attribution, and short
demo media. The operator ritual (draft script, curation, recording slots) is
documented in [`docs/weekly-changelog.md`](https://github.com/Untrivial-ai/agent-orchestrator/blob/main/docs/weekly-changelog.md).

AO also ships continuously through GitHub Releases. The release page is the
source of truth for desktop versions, supported artifacts, changes, and upgrade
notes.
...
- [Weekly product changelog](https://orchestrator.inc/changelog)
- [Current desktop releases](https://github.com/Untrivial-ai/agent-orchestrator/releases)
- [Current source history](https://github.com/Untrivial-ai/agent-orchestrator/commits/main)
