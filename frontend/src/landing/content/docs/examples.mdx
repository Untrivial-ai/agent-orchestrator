...
<Cards>
	<Card title="Quickstart" href="/docs/quickstart" description="Download, open a folder, chat, and pair your phone." />
	<Card title="When you're ready for a team of agents" href="/docs/team-of-agents" description="Authenticate gh and run the pull-request loop." />
