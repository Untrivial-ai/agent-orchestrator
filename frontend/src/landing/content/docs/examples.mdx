...
Create another task and choose **Terminal UI**. AO creates the worktree and launches the harness's native interface through its native terminal host on every platform.
