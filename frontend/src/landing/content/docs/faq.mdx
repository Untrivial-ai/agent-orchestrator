...
<Accordions expandAll>
	...
	<Accordion title="Does it work on Windows?">
		Yes. Windows supports the desktop app, Chat, and native Terminal UI through AO's conpty host. The tmux fallback and iTerm2-specific behavior apply only to other platforms.
	</Accordion>
