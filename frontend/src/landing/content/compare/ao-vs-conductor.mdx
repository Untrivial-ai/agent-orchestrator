...
Both products isolate work with Git worktrees. [Conductor documents a separate branch and working tree for each workspace](https://www.conductor.build/docs/concepts/parallel-agents); [AO tracks each isolated session until it becomes a pull request](https://orchestrator.inc/docs/).
