...
<Accordions>
	...
	<Accordion title="macOS says the developer cannot be verified">
		In Finder, right-click Agent Orchestrator, choose Open, then choose Open again in the confirmation dialog. If macOS still blocks the app, run these diagnostics and include the output when opening an issue:
		```bash
		sw_vers
...
<Cards>
	<Card title="Quickstart" description="Create a project and run the first worker." href="/quickstart" />
	<Card title="Platforms" description="Review platform downloads and terminal behavior." href="/platforms" />
	<Card title="Troubleshooting" description="Diagnose desktop, daemon, and agent problems." href="/troubleshooting" />
</Cards>
