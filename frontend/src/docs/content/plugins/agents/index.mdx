...
| `prime-agent` | `autohand` | `omp` | `junie` (experimental) |
...
<Cards>
	<Card title="Claude Code" description="Terminal UI and structured Chat." href="/plugins/agents/claude-code" />
	<Card title="Codex" description="Terminal UI and native app-server Chat." href="/plugins/agents/codex" />
	<Card title="OpenCode" description="Terminal UI and native ACP Chat." href="/plugins/agents/opencode" />
	<Card title="Cursor" description="Built-in terminal harness." href="/plugins/agents/cursor" />
	<Card title="Aider" description="Built-in terminal harness." href="/plugins/agents/aider" />
</Cards>
