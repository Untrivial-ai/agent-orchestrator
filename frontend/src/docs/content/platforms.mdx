...
Use the download selector on [Installation](/installation) for the current release. Installed builds check for updates on launch and periodically while running.
...
If macOS says the developer cannot be verified, follow the Gatekeeper steps in [Common Installation Problems](/installation#common-installation-problems).
...
- Scanning the pairing QR fills the advertised host, port, connection password, and any secure transport mode automatically. Treat the QR as a bearer credential: do not share it or screenshots of it, and rotate the connection password if it is exposed.
...
<Cards>
	<Card title="Installation" href="/installation" description="Download AO and connect GitHub and an agent harness." />
	<Card title="Dashboard" href="/dashboard" description="Learn the desktop and mobile control surfaces." />
	<Card title="Troubleshooting" href="/troubleshooting" description="Resolve platform-specific startup and terminal issues." />
</Cards>
