		...
		({ version, daemonState, daemonPort, updateStatus, updateSettings }) => {
			...
			const ao = {
				...
				browser: {
					...
					getSiteSettings: async () => { throw new Error("Site settings unavailable in renderer smoke tests"); },
					setSitePermission: async () => { throw new Error("Site settings unavailable in renderer smoke tests"); },
					resetSitePermissions: async () => { throw new Error("Site settings unavailable in renderer smoke tests"); },
					clearSiteData: async () => undefined,
