...
func runSpawn(ctx context.Context, c *client, args []string) error {
	...
	flags.StringVar(&harness, "harness", "opencode", "agent harness")
	flags.StringVar(&harness, "agent", "opencode", "alias for --harness")
...
func printUsage(out io.Writer) {
  ...
  ao spawn --name NAME --prompt TEXT [--agent opencode] [--mode standard|trusted]
  ao list [--json] [--all]
